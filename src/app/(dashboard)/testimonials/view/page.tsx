...
export default function TestimonialsViewPage() {
  ...
  const canView = hasPerm(perms, "testimonials", "view");
  const canEdit = hasPerm(perms, "testimonials", "edit");
  const canDelete = hasPerm(perms, "testimonials", "delete");
        ...
        <table className="min-w-full text-sm">
          <thead>
            <tr className="bg-gray-50 text-gray-600">
              ...
              <th className="px-4 py-3 text-left font-medium">Patient Testimonials Details</th>
            ...
            {loading ? (
              ...
              rows.map((r, i) => (
                <tr key={r.id} className={i % 2 ? "bg-white" : "bg-gray-50/50"}>
                  ...
                  <td className="px-4 py-3">{r.video_link || "-"}</td>
